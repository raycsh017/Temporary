...
class HomePrayerEntryTableViewCell: UITableViewCell {
	...
	weak var delegate: HomePrayerEntryTableViewCellDelegate?
	var prayerEntryCellData: HomePrayerEntryCellData?
...
extension HomePrayerEntryTableViewCell: CellUpdatable {
	typealias CellData = HomePrayerEntryCellData
